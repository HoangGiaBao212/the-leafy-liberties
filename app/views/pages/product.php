        ...
        ?>
            ...
            <div class="box-border py-3 border border-gray-400 border-solid border-x-0">
                ...
                <div class="flex items-center justify-start w-full gap-3 mt-4">
                    <div class="flex items-center justify-between gap-2 px-3 py-2 text-lg transition-all border border-gray-300 rounded-full cursor-pointer bg-gray-50 hover:bg-primary-500 hover:text-gray-700 group"
                    ...
                    <div class="<?php echo ($auth->hasPermission("product.access") && $auth->hasPermission("dashboard.access") ? 'hidden' : 'block') ?> flex items-center justify-between gap-2 px-3 py-2 text-lg transition-all border border-gray-300 rounded-full cursor-pointer bg-gray-50 hover:bg-primary-500 hover:text-gray-700 group"
                        ...
                        <button type="submit" src="" alt=""
                            class="text-sm font-medium sm:text-base md:text-lg add-to-wishlist">
                            <?php
          ...
          ?>
            ...
            <div class="flex items-center justify-start gap-4 mt-10">
                <a href="https://www.facebook.com/MTC.Chinh.2709">
                    <i
                ...
                <a href="https://www.facebook.com/GiaBao.V">
                    <i
                ...
                ?>
                    <div class="flex flex-row justify-start review ">
                        <div class="review-header">
                            <img src="<?php echo ($userReview->image == NULL) ? BASE_URI . '/resources/images/user/placeholder.png' : BASE_URI . $userReview->image ?>"
                    ...
                    <form id="update-form<?php echo $review->id ?>"
                        ...
                        <div class="">
                            <input id="update-input<?php echo $review->id ?>" value="<?php echo $review->content ?>"
                                type="text" name="update-comment" placeholder="Edit a comment..." required
                    ...
                    ?>
                            <div class="flex flex-row">
                                ...
                                <div
                                    ...
                                    <span id="new-comment-button"
                                        onclick="openNewComment(<?php echo $userReview->id ?>)" type="submit"
              ...
              ?>
                ...
                <div class="mt-20 ">
                    <form id="comment-form" action="<?php echo BASE_URI . "/product/comment" . "?id=" . $product->id ?>"
                        ...
                        <img src="<?php echo $user ? (($user && $user->image == NULL) ? BASE_URI . '/resources/images/user/placeholder.png' : BASE_URI . $user->image) : BASE_URI . '/resources/images/user/placeholder.png' ?> "
                        ...
                        <div class="w-full mx-5">
                            ...
                            <input id="new-comment-input" type="text" name="new-comment" placeholder="Add a comment..."
                                required class="w-full border-b-2 border-gray-300"
                                oninvalid="this.setCustomValidity('Please enter a comment')"
                                oninput="setCustomValidity('')">
                            <?php
                if ($user && $user->role_id != 3):
                  ?>
                            <div class="flex items-center mt-4 mb-4">
                                <span class="mr-2">Rating : </span>
                                <div class="flex">
                                    <label id="startLabel1" for="star1"
                                        class="px-1 text-2xl text-gray-300 cursor-pointer">&#9733;</label>
                                    <input type="radio" id="star1" name="rating" value="1" class="hidden" />
                                    <label id="startLabel2" for="star2"
                                        class="px-1 text-2xl text-gray-300 cursor-pointer">&#9733;</label>
                                    <input type="radio" id="star2" name="rating" value="2" class="hidden" />
                                    <label id="startLabel3" for="star3"
                                        class="px-1 text-2xl text-gray-300 cursor-pointer">&#9733;</label>
                                    <input type="radio" id="star3" name="rating" value="3" class="hidden" />
                                    <label id="startLabel4" for="star4"
                                        class="px-1 text-2xl text-gray-300 cursor-pointer">&#9733;</label>
                                    <input type="radio" id="star4" name="rating" value="4" class="hidden" />
                                    <label id="startLabel5" for="star5"
                                        class="px-1 text-2xl text-gray-300 cursor-pointer">&#9733;</label>
